...
![[Types of Threads.png#invert|500]]

## Fundamental Threads

All threads ride on either Soul, the fundamental energy of the Sive, or Chaos, the fundamental energy of Dive. Rings ride on three Soul, while binds ride on three Chaos. When loops come in contact, a flow may form.
...
In summary, the types of flow are:
...
![[Relations Among Threads.png#invert|500]]

## Fieldful Flow

Every loop thread contains around it a field formed by its analogous thread. This field is called a potential field, because its analogous thread is not fully realized, as it is riding only on two threads of Soul. Flow threads only present their full effect when they are riding on 3 space threads. Below is a potential magnetic field.

![[Magnetic Field.png#invert|350]]

Most flow threads in nature are fully realized, as shown in the figure below. Taren’s field of Xenir is flowing not back on itself, but into Nazem, trying to balance it out. At the same time, Nazem’s field of Iji is flowing also into its opposite Taren.

![[Material Field.png#invert|800]]

This representation above, however, is purely didactic, as in reality the Material field is more closely represented by the figure below, where Taren and Nazem occupy the same space, as well as Xenir and Iji. All of these four threads of Charge combined forms what’s called the [[Elements|Material Field]], the fundamental building block of matter in the universe.

![[Material Field Unified.png#invert|350]]
...
The effect is a gradient, increasing as it reaches the opposite space and reaching full effect in the last instant. However, three regions can be identified:

- Non-realization: in this first region, as the thread covers the first x distance from one space to another it produces almost no effect.

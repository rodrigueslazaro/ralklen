...
Because Nazem increases, and a loop always brings with it a field of its analogous thread, in this case Iji, it will flow into Wala, finishing the balancing process by *parallel balancing*.
...
Because Nazem increases, and a loop always brings with it a field of its analogous thread, in this case Iji, the Taren will have to increase as well to receive the field of Iji, another step of *disparate accommodation*, finishing the balancing process.
...
2) After the first disparate accommodation takes place we have:
	- Taren 3s
	- Xenir 2s1c
	- Asor 2s1c
	- Iji 1s2c
...
3) After the second disparate accommodation takes place we have:
	- 2 Taren 3s
	- Xenir 2s1c
	- Asor 2s1c
	- 2 Iji 1s2c
